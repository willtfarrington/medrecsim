...
| `WHO-HIGH5S-SOP-2014` | A | WHO · *High 5s Project: Standard Operating Protocol — Assuring Medication Accuracy at Transitions in Care* · v3, 2014 | (pointer: WHO High 5s project page) | 2026-08-23 (planning) | not re-fetched this session | Dated; pair with WHO *Medication Without Harm* (2017) when cited. **Re-verify at EP-7.** |
